...
std::string Base64::encode(const std::vector<char>& buf)
{
	return encode(&buf[0], static_cast<int>(buf.size()));
}

std::string Base64::encode(const char* buf, int bufLen)
{
...
std::vector<char> Base64::decode(std::string encoded_string)
{
