...
*/
std::wstring MediaLibCleaner::ReplaceAllAliasOccurences(std::wstring& wcfg, MediaLibCleaner::File* audiofile, std::string path, time_t datetime_raw, int total_files) {
